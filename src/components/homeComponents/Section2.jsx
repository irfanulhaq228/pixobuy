...
const Section2 = React.forwardRef((props, ref) => {
  return (
    <div className="flex justify-center py-[50px] lg:py-[60px]" ref={ref}>
      <div className="max-w-[1300px] 2xl:max-w-[1400px] w-full flex flex-col xl:flex-row gap-[30px] px-[10px]">
        ...
        <div className="w-full flex flex-col items-center xl:items-end gap-[30px] xl:pe-[80px] justify-center">
          <img src={img} className="max-w-[200px] sm:max-w-[300px]" />
          <p className="text-[30px] sm:text-[40px] font-[700] leading-[50px] text-center xl:text-end max-w-[500px] text-gray-600">
            We'll Help You Find the Best Product
          </p>
          <p className="text-center xl:text-end max-w-[550px] font-[500] text-gray-500 text-[15px] sm:text-[16px]">
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-center xl:justify-end gap-[20px]">
            <img
              src={img2}
              className="w-[170px] sm:w-[200px] rounded-lg transition-all duration-300 cursor-pointer hover:scale-[1.03]"
            />
            <img
              src={img3}
              className="w-[170px] sm:w-[200px] rounded-lg transition-all duration-300 cursor-pointer hover:scale-[1.03]"
